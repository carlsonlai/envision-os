...
import { getQuotation } from '@/services/bukku'
import { createProjectFromQuotation } from '@/services/brief-creator'
...
export async function POST(
  ...
  try {
    ...
    const project = await createProjectFromQuotation(quotation)
